              ...
              <div className="modal-section">
                ...
                <div className="time-grid">
                  <label className="input-label">
                    Inizio
                    <select name="start" value={blockForm.start} onChange={updateBlockForm}>
                      {modalDay.availableRanges?.flatMap(range => toTimeOptions(range)).map(option => (
                  ...
                  <label className="input-label">
                    Fine
                    <select name="end" value={blockForm.end} onChange={updateBlockForm}>
                      {buildEndOptions(modalDay.availableRanges || [], blockForm.start).map(option => (
