...
const userSchema = new mongoose.Schema({
  ...
  legal_address: { type: String, trim: true, maxlength: 200 },
  legal_zip_code: { type: String, trim: true, maxlength: 20 },
  legal_city: { type: String, trim: true, maxlength: 120 },
  legal_province: { type: String, trim: true, maxlength: 120 },
  legal_country: { type: String, trim: true, maxlength: 120 },
